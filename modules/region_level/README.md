...
| <a name="input_s3_access_logs_bucket_attach_access_log_delivery_policy"></a> [s3\_access\_logs\_bucket\_attach\_access\_log\_delivery\_policy](#input\_s3\_access\_logs\_bucket\_attach\_access\_log\_delivery\_policy) | Attach S3 access logs delivery policy to the bucket. | `bool` | `true` | no |
...
| <a name="input_s3_access_logs_bucket_attach_elb_access_logs_policy"></a> [s3\_access\_logs\_bucket\_attach\_elb\_access\_logs\_policy](#input\_s3\_access\_logs\_bucket\_attach\_elb\_access\_logs\_policy) | Attach ELB access logs delivery policy to the bucket. | `bool` | `true` | no |
| <a name="input_s3_access_logs_bucket_attach_lb_log_delivery_policy"></a> [s3\_access\_logs\_bucket\_attach\_lb\_log\_delivery\_policy](#input\_s3\_access\_logs\_bucket\_attach\_lb\_log\_delivery\_policy) | Attach LB access logs delivery policy to the bucket. | `bool` | `true` | no |
